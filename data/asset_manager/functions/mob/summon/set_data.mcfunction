...
#> Private 
# @private
    #declare function mob_manager:init/multiplay_multiplier/normal
    #declare function mob_manager:init/multiplay_multiplier/angel
    #declare function mob_manager:init/multiplay_multiplier/normal
    #declare function asset_manager:mob/summon/set_tag
    #declare function mob_manager:init/
    #declare function metric:angel/summon.m
    #declare storage rom:
    #declare team Enemy
...
# 属性耐性
    ...
    # 火・水・雷の耐性が1未満ならそれにめちゃくちゃ固くしてしまう
        function asset_manager:mob/summon/over_resist.m {Element:"Fire"}
        function asset_manager:mob/summon/over_resist.m {Element:"Water"}
        function asset_manager:mob/summon/over_resist.m {Element:"Thunder"}
