...
# Mobの説明文 (TextComponentString[]) (オプション)
    data modify storage asset:mob Lore set value ['{"text":"ブーーーーン！","color":"white"}','{"text":"毒は持ってるので注意。","color":"white"}']
# 武器
...
# 属性倍率 // 1.0fで100% 最低でも25%は軽減されずに入る
    ...
    # 火倍率 (float) (オプション)
        data modify storage asset:mob Resist.Fire set value 1.1
    # 水倍率 (float) (オプション)
