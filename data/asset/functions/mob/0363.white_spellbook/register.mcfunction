#> asset:mob/0363.white_spellbook/register
#
# Mobのデータを指定
#
...
# ID (int)
    data modify storage asset:mob ID set value 363
# Type (string) Wikiを参照
    data modify storage asset:mob Type set value "Enemy"
# 干渉可能か否か (boolean)
    data modify storage asset:mob Interferable set value true
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"白呪の魔導書","color":"white"}'
# Mobの説明文 (TextComponentString[]) (オプション)
    data modify storage asset:mob Lore set value ['{"text":"まっしろな本。","color":"white"}','{"text":"速くなったり遅くなったりとやかましい。","color":"white"}','{"text":"魔法耐性を下げる攻撃をするので要注意だ。","color":"white"}']
# 武器
...
# 防具
    # 頭 (Compound(Item)) (オプション)
        data modify storage asset:mob Armor.Head set value {id:"minecraft:stick",Count:1b,tag:{CustomModelData:20350}}
