...
# 着火し始めた瞬間の演出
    execute if score @s 3v.Time matches 100 run playsound minecraft:entity.creeper.primed hostile @a ~ ~ ~ 1 0.5
    execute if score @s 3v.Time matches 100 run particle flame ^ ^ ^ 0.2 0.2 0.2 0 5 normal
