#> asset:mob/0160.freeze_archer/register
# @within asset:mob/alias/160/register
...
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"氷結ノ弓兵","color":"#B3FCFF"}'
# Mobの説明文 (TextComponentString[]) (オプション)
    data modify storage asset:mob Lore set value ['{"text":"氷ノ弓デ氷像ヲ作ル弓兵。","color":"white"}','{"text":"アナタハイイ素材ニナルダロウ。","color":"white"}']
# 武器
...
# 防具
    # 頭 (Compound(Item)) (オプション)
        data modify storage asset:mob Armor.Head set value {id:"packed_ice",Count:1b}
    # 胴 (Compound(Item)) (オプション)
        data modify storage asset:mob Armor.Chest set value {id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:11795711}}}
