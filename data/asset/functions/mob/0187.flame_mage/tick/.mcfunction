...
# 攻撃
    ...
    execute if entity @s[scores={General.Mob.Tick=15}] run function asset:mob/0187.flame_mage/tick/shoot_magic
    execute if entity @s[scores={General.Mob.Tick=15..}] store result score @s General.Mob.Tick run random value -90..-70
