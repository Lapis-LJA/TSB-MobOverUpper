...
# Mobの説明文 (TextComponentString[]) (オプション)
    data modify storage asset:mob Lore set value ['{"text":"雷の力を纏った魔物。","color":"white"}','{"text":"瞬間移動を得意とし、あなたを翻弄する。","color":"white"}']
# Mobの説明文 (TextComponentString[]) (オプション)
...
# フィールド
    ...
    data modify storage asset:mob Field.MPReduce set value 6
