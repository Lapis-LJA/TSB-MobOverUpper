...
# 予告
    ...
    execute if score @s General.Mob.Tick matches 23..63 at @e[type=marker,tag=AC.ModelLocator.Weapon,distance=..8,sort=nearest,limit=1] rotated as @s facing ^1.5 ^ ^5 run function asset:mob/0372.tutankhamen/tick/skill/laser/alert
    execute if score @s General.Mob.Tick matches 23..63 at @e[type=marker,tag=AC.ModelLocator.Weapon,distance=..8,sort=nearest,limit=1] rotated as @s facing ^-1.5 ^ ^5 run function asset:mob/0372.tutankhamen/tick/skill/laser/alert
...
# 数Tickごとにレーザー
    ...
    execute if score $Interval Temporary matches 0 if score @s General.Mob.Tick matches 63..100 at @e[type=marker,tag=AC.ModelLocator.Weapon,distance=..8,sort=nearest,limit=1] rotated as @s positioned ^ ^ ^-2 facing ^1.5 ^ ^5 run function asset:mob/0372.tutankhamen/tick/skill/laser/shoot/
    execute if score $Interval Temporary matches 0 if score @s General.Mob.Tick matches 63..100 at @e[type=marker,tag=AC.ModelLocator.Weapon,distance=..8,sort=nearest,limit=1] rotated as @s positioned ^ ^ ^-2 facing ^-1.5 ^ ^5 run function asset:mob/0372.tutankhamen/tick/skill/laser/shoot/
