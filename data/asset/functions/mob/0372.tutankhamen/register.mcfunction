...
# 怨霊弾
    data modify storage asset:mob Field.Damage.ManyShoot set value 40f
# レーザー
    data modify storage asset:mob Field.Damage.Laser set value 45f
# ハイパーレーザー
    data modify storage asset:mob Field.Damage.HyperLaser set value 100f
# 突進
    data modify storage asset:mob Field.Damage.Dash.Charge set value 40f
# ダッシュからの斬撃
    data modify storage asset:mob Field.Damage.Dash.Slash set value 60f
