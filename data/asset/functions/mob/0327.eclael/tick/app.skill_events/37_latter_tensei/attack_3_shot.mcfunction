#> asset:mob/0327.eclael/tick/app.skill_events/37_latter_tensei/attack_3_shot
#
# 
#
# @within function asset:mob/0327.eclael/tick/app.skill_events/37_latter_tensei/attack_3

# 基準
    summon area_effect_cloud ^ ^ ^ {Duration:1,Tags:["93.Temp.AttackRotation"]}

# ライン斬撃Root
    execute as @e[type=area_effect_cloud,tag=93.Temp.AttackRotation,distance=..80] run tp @s ~ ~ ~ ~30 0
