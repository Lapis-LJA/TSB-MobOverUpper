#> asset:mob/0327.eclael/tick/app.skill_events/37_latter_tensei/attack_3
#
# 
#
...
# 全プレイヤーに向けて発動
    execute as @e[type=area_effect_cloud,tag=93.Temp.AttackPosition,distance=..80] facing entity @s feet as @e[type=wither_skeleton,tag=93.EntityRoot,distance=..80] positioned as @s run function asset:mob/0327.eclael/tick/app.skill_events/37_latter_tensei/attack_3_shot
