...
# 攻撃
    ...
    execute if score @s 93.AnimationTimer matches 93 if predicate api:global_vars/difficulty/min/2_hard run function asset:mob/0327.eclael/tick/app.skill_events/37_latter_tensei/attack_3
