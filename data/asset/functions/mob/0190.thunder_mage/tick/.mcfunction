...
# 発動
    ...
    execute if entity @s[scores={General.Mob.Tick=5}] run function asset:mob/0190.thunder_mage/tick/attack


    execute if entity @s[scores={General.Mob.Tick=5..}] store result score @s General.Mob.Tick run random value -80..-50
