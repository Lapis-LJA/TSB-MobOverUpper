...
execute if score @s 1A.LifeTime matches 1680 if predicate api:global_vars/difficulty/min/3_blessless positioned ~07.5 ~6 ~-016 rotated 000 0 run function asset:mob/0046.clock_of_despair/tick/skill/common/wall_laser_clock/summon
execute if score @s 1A.LifeTime matches 1680 if predicate api:global_vars/difficulty/min/3_blessless positioned ~0016 ~6 ~07.5 rotated 090 0 run function asset:mob/0046.clock_of_despair/tick/skill/common/wall_laser_clock/summon
execute if score @s 1A.LifeTime matches 1680 if predicate api:global_vars/difficulty/min/3_blessless positioned ~-7.5 ~6 ~0016 rotated 180 0 run function asset:mob/0046.clock_of_despair/tick/skill/common/wall_laser_clock/summon
execute if score @s 1A.LifeTime matches 1680 if predicate api:global_vars/difficulty/min/3_blessless positioned ~-016 ~6 ~-7.5 rotated 270 0 run function asset:mob/0046.clock_of_despair/tick/skill/common/wall_laser_clock/summon

execute if score @s 1A.LifeTime matches 1680 if predicate api:global_vars/difficulty/max/2_hard positioned ~ ~0.03 ~ run function asset:mob/0046.clock_of_despair/tick/skill/common/fire/summon.m {Delay:85}
execute if score @s 1A.LifeTime matches 1680 if predicate api:global_vars/difficulty/min/3_blessless positioned ~ ~0.03 ~ run function asset:mob/0046.clock_of_despair/tick/skill/common/fire/summon.m {Delay:100}
