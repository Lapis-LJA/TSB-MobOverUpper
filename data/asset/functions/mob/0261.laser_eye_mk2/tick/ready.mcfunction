...
# 一定スコアで射撃
    ...
    execute if score @s General.Mob.Tick matches 30 run function asset:mob/0261.laser_eye_mk2/tick/shoot
    execute if score @s General.Mob.Tick matches 40 run function asset:mob/0261.laser_eye_mk2/tick/shoot
