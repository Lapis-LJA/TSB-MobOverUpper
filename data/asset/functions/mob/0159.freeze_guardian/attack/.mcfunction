#> asset:mob/0159.freeze_guardian/attack/
#
# Mobの攻撃時の処理
#
# @within function asset:mob/alias/159/attack
...
# ダメージ
    ...
    data modify storage api: Argument.DeathMessage append value '{"translate": "%1$sは%2$sによって凍り付き、斬り裂かれた","with":[{"selector":"@s"},{"nbt":"Return.AttackerName","storage":"lib:","interpret":true}]}'
...
# Stack = Difficulty * 3 - 1
    ...
    data modify storage api: Argument set value {ID:17,Duration:120}
